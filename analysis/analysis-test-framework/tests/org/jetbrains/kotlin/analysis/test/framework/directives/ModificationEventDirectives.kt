...
fun TestModuleStructure.publishModificationEventByDirective(project: Project, module: KtModule?) {
    val modificationEventKind = allDirectives[ModificationEventDirectives.MODIFICATION_EVENT].singleOrNull()
        ?: error("Please specify exactly one `MODIFICATION_EVENT` kind.")
