...
Kotlin_mm_safePointFunctionPrologue.exit:         ; preds = %17, %entry
  %18 = load atomic i32, i32* @"state_global$<root>$/home/loewe/tabs/kmm-research/kotlin-native/aoPassBenchmarking/benchmarkAnalysis/Ring::ParameterNotNull.invokeEightArgsWithoutNullCheck/Main.kt" acquire, align 4
  %19 = icmp eq i32 %18, 2
  br i1 %19, label %epilogue, label %call_success

call_success:                                     ; preds = %Kotlin_mm_safePointFunctionPrologue.exit
  call fastcc void @CallInitGlobalPossiblyLock(i32* nonnull @"state_global$<root>$/home/loewe/tabs/kmm-research/kotlin-native/aoPassBenchmarking/benchmarkAnalysis/Ring::ParameterNotNull.invokeEightArgsWithoutNullCheck/Main.kt", void ()* nonnull @"kfun:$init_global#internal")
  br label %epilogue
