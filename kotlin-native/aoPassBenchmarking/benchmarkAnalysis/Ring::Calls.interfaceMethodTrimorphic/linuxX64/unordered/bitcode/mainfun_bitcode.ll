...
Kotlin_mm_safePointWhileLoopBody.exit.i:          ; preds = %137, %do_while_loop.i
  ...
  switch i32 %.urem, label %when_next6.i [
    ...
    i32 2, label %when_exit7.i.fold.split
  ]

when_next6.i:                                     ; preds = %Kotlin_mm_safePointWhileLoopBody.exit.i
  br label %when_exit7.i

when_exit7.i.fold.split:                          ; preds = %Kotlin_mm_safePointWhileLoopBody.exit.i
  br label %when_exit7.i
