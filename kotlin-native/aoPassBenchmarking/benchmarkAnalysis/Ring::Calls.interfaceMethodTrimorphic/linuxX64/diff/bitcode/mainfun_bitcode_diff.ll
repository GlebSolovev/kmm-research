--- ../../benchmarkAnalysis/Ring::Calls.interfaceMethodTrimorphic/linuxX64/baseline/bitcode/mainfun_bitcode.ll	2023-07-19 02:52:01.240565987 +0200
+++ ../../benchmarkAnalysis/Ring::Calls.interfaceMethodTrimorphic/linuxX64/unordered/bitcode/mainfun_bitcode.ll	2023-07-19 03:03:35.680351256 +0200
@@ -13,11 +13,11 @@
...
-  %131 = bitcast %struct.ObjHeader* %86 to i64**
...
+  %133 = load atomic %struct.ObjHeader*, %struct.ObjHeader** %132 unordered, align 8
 ...
 do_while_loop.i:                                  ; preds = %when_exit7.i, %Kotlin_mm_safePointFunctionPrologue.exit
-  %inductionVariable.0.i = phi i32 [ 0, %Kotlin_mm_safePointFunctionPrologue.exit ], [ %137, %when_exit7.i ]
...
-  br i1 %135, label %Kotlin_mm_safePointWhileLoopBody.exit.i, label %136
+  %inductionVariable.0.i = phi i32 [ 0, %Kotlin_mm_safePointFunctionPrologue.exit ], [ %138, %when_exit7.i ]
+  %134 = load atomic i8, i8* getelementptr inbounds (%"struct.std::atomic_flag", %"struct.std::atomic_flag"* @_ZN6kotlin2mm8internal20gSuspensionRequestedE, i64 0, i32 0, i32 0) seq_cst, align 1
+  %135 = and i8 %134, 1
+  %136 = icmp eq i8 %135, 0
+  br i1 %136, label %Kotlin_mm_safePointWhileLoopBody.exit.i, label %137
 
-136:                                              ; preds = %do_while_loop.i
+137:                                              ; preds = %do_while_loop.i
   call fastcc void @_ZN6kotlin2mm26SuspendIfRequestedSlowPathEv() #37
   br label %Kotlin_mm_safePointWhileLoopBody.exit.i
 
-Kotlin_mm_safePointWhileLoopBody.exit.i:          ; preds = %136, %do_while_loop.i
-  %137 = add nuw nsw i32 %inductionVariable.0.i, 1
+Kotlin_mm_safePointWhileLoopBody.exit.i:          ; preds = %137, %do_while_loop.i
+  %138 = add nuw nsw i32 %inductionVariable.0.i, 1
   %.urem = urem i32 %inductionVariable.0.i, 3
   switch i32 %.urem, label %when_next6.i [
     i32 1, label %when_exit7.i
@@ -215,18 +216,19 @@
   br label %when_exit7.i
 
 when_exit7.i:                                     ; preds = %when_exit7.i.fold.split, %when_next6.i, %Kotlin_mm_safePointWhileLoopBody.exit.i
-  %138 = phi i64* [ %132, %when_next6.i ], [ %128, %Kotlin_mm_safePointWhileLoopBody.exit.i ], [ %130, %when_exit7.i.fold.split ]
-  %139 = load atomic volatile i64, i64* %138 monotonic, align 8
-  %140 = and i64 %139, -4
-  %141 = inttoptr i64 %140 to i64*
-  %142 = load atomic volatile i64, i64* %141 monotonic, align 8
-  %exitcond.not = icmp eq i32 %137, 1000000
+  %139 = phi %struct.ObjHeader* [ %133, %when_next6.i ], [ %129, %Kotlin_mm_safePointWhileLoopBody.exit.i ], [ %131, %when_exit7.i.fold.split ]
+  %140 = bitcast %struct.ObjHeader* %139 to i64*
+  %141 = load atomic volatile i64, i64* %140 monotonic, align 8
+  %142 = and i64 %141, -4
+  %143 = inttoptr i64 %142 to i64*
+  %144 = load atomic volatile i64, i64* %143 monotonic, align 8
+  %exitcond.not = icmp eq i32 %138, 1000000
   br i1 %exitcond.not, label %epilogue, label %do_while_loop.i
 
 epilogue:                                         ; preds = %when_exit7.i
-  %143 = getelementptr inbounds %"class.kotlin::SingleLockList<kotlin::mm::ThreadData, std::recursive_mutex, kotlin::std_support::allocator<kotlin::mm::ThreadData>>::Node", %"class.kotlin::SingleLockList<kotlin::mm::ThreadData, std::recursive_mutex, kotlin::std_support::allocator<kotlin::mm::ThreadData>>::Node"* %7, i64 0, i32 1, i32 5
-  %144 = load i64, i64* %13, align 8, !tbaa !9
-  %145 = bitcast %"class.kotlin::mm::ShadowStack"* %143 to i64*
-  store i64 %144, i64* %145, align 8, !tbaa !7
+  %145 = getelementptr inbounds %"class.kotlin::SingleLockList<kotlin::mm::ThreadData, std::recursive_mutex, kotlin::std_support::allocator<kotlin::mm::ThreadData>>::Node", %"class.kotlin::SingleLockList<kotlin::mm::ThreadData, std::recursive_mutex, kotlin::std_support::allocator<kotlin::mm::ThreadData>>::Node"* %7, i64 0, i32 1, i32 5
+  %146 = load atomic i64, i64* %13 unordered, align 8, !tbaa !9
+  %147 = bitcast %"class.kotlin::mm::ShadowStack"* %145 to i64*
