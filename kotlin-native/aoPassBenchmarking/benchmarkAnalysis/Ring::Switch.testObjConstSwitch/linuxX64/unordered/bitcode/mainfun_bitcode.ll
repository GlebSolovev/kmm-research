...
Kotlin_mm_safePointFunctionPrologue.exit:         ; preds = %22, %entry
  %23 = load atomic i32, i32* @"state_global$<root>$/home/loewe/tabs/kmm-research/kotlin-native/aoPassBenchmarking/benchmarkAnalysis/Ring::Switch.testObjConstSwitch/Main.kt" acquire, align 4
  %24 = icmp eq i32 %23, 2
  br i1 %24, label %call_success1, label %call_success

call_success:                                     ; preds = %Kotlin_mm_safePointFunctionPrologue.exit
  call fastcc void @CallInitGlobalPossiblyLock(i32* nonnull @"state_global$<root>$/home/loewe/tabs/kmm-research/kotlin-native/aoPassBenchmarking/benchmarkAnalysis/Ring::Switch.testObjConstSwitch/Main.kt", void ()* nonnull @"kfun:$init_global#internal")
...
"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i": ; preds = %label_init.i.i, %Kotlin_mm_safePointWhileLoopBody.exit.i
  ...
  switch i32 %68, label %when_next38.i.i [
    ...
    i32 2, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split"
    i32 3, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split3"
    i32 4, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split4"
    i32 5, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split5"
    i32 6, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split6"
    i32 7, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 8, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split7"
    i32 9, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 10, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split8"
    i32 11, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split9"
    i32 12, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split10"
    i32 13, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split11"
    i32 14, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split12"
    i32 15, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split13"
    i32 16, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split14"
    i32 17, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 18, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 19, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 20, label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"
  ]

when_next38.i.i:                                  ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split3": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split4": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split5": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split6": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split7": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split8": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split9": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split10": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split11": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split12": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split13": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split14": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i": ; preds = %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split14", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split13", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split12", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split11", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split10", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split9", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split8", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split7", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split6", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split5", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split4", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split3", %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split", %when_next38.i.i, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  %t.0.i.i = phi i32 [ 5, %when_next38.i.i ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 3, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split" ], [ 4, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split3" ], [ 5, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split4" ], [ 6, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split5" ], [ 7, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split6" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 9, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split7" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 2, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split8" ], [ 3, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split9" ], [ 4, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split10" ], [ 4, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split11" ], [ 4, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split12" ], [ 435, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split13" ], [ 31, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split14" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ]
...
loop_check.i:                                     ; preds = %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i", %"kfun:SwitchBenchmark#<get-denseIntData>(){}kotlin.IntArray.exit.i"
  %indvars.iv = phi i64 [ %indvars.iv.next, %"kfun:SwitchBenchmark#objConstSwitch(kotlin.Int){}kotlin.Int.exit.i" ], [ 0, %"kfun:SwitchBenchmark#<get-denseIntData>(){}kotlin.IntArray.exit.i" ]
