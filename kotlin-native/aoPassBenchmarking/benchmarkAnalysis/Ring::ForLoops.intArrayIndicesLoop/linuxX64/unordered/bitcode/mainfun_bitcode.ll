...
Kotlin_mm_safePointFunctionPrologue.exit:         ; preds = %21, %entry
  ...
  store %struct.TypeInfo* getelementptr inbounds ({ %struct.TypeInfo, [3 x i8*] }, { %struct.TypeInfo, [3 x i8*] }* @"ktypeglobal:kotlin.IntArray#internal", i64 0, i32 0), %struct.TypeInfo** %41, align 8, !tbaa !16
...
while_loop.i:                                     ; preds = %loop_check.i
  ...
  %50 = and i8 %49, 1
  %51 = icmp eq i8 %50, 0
  br i1 %51, label %Kotlin_mm_safePointWhileLoopBody.exit.i2, label %52

52:                                               ; preds = %while_loop.i
  call fastcc void @_ZN6kotlin2mm26SuspendIfRequestedSlowPathEv() #37
  br label %Kotlin_mm_safePointWhileLoopBody.exit.i2

Kotlin_mm_safePointWhileLoopBody.exit.i2:         ; preds = %52, %while_loop.i
...
56:                                               ; preds = %Kotlin_mm_safePointWhileLoopBody.exit.i2
  call fastcc void @ThrowArrayIndexOutOfBoundsException() #50
  unreachable

Kotlin_IntArray_set.exit.i:                       ; preds = %Kotlin_mm_safePointWhileLoopBody.exit.i2
...
loop_check.i:                                     ; preds = %Kotlin_IntArray_set.exit.i, %Kotlin_mm_safePointFunctionPrologue.exit
  %indvars.iv = phi i64 [ %indvars.iv.next, %Kotlin_IntArray_set.exit.i ], [ 0, %Kotlin_mm_safePointFunctionPrologue.exit ]
  %exitcond.not = icmp eq i64 %indvars.iv, 10000
  br i1 %exitcond.not, label %call_success, label %while_loop.i

call_success:                                     ; preds = %loop_check.i
  %60 = getelementptr inbounds %struct.ObjHeader, %struct.ObjHeader* %objHeader, i64 1
  ...
  br i1 %71, label %do_while_loop.i, label %epilogue

do_while_loop.i:                                  ; preds = %Kotlin_mm_safePointWhileLoopBody.exit.i, %call_success
  %inductionVariable.0.i = phi i32 [ %76, %Kotlin_mm_safePointWhileLoopBody.exit.i ], [ 0, %call_success ]
...
75:                                               ; preds = %do_while_loop.i
  call fastcc void @_ZN6kotlin2mm26SuspendIfRequestedSlowPathEv() #37
  br label %Kotlin_mm_safePointWhileLoopBody.exit.i

Kotlin_mm_safePointWhileLoopBody.exit.i:          ; preds = %75, %do_while_loop.i
  %76 = add i32 %inductionVariable.0.i, 1
  %.not.i = icmp sgt i32 %76, %70
  br i1 %.not.i, label %epilogue, label %do_while_loop.i

epilogue:                                         ; preds = %Kotlin_mm_safePointWhileLoopBody.exit.i, %call_success
