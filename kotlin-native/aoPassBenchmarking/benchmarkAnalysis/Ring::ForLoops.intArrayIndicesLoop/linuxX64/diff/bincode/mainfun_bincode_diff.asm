--- ../../benchmarkAnalysis/Ring::ForLoops.intArrayIndicesLoop/linuxX64/baseline/bincode/mainfun_bincode.asm	2023-07-19 02:54:38.300514847 +0200
+++ ../../benchmarkAnalysis/Ring::ForLoops.intArrayIndicesLoop/linuxX64/unordered/bincode/mainfun_bincode.asm	2023-07-19 03:06:03.660303995 +0200
@@ -9,7 +9,7 @@
                	movaps	%xmm0, 32(%rsp)
                	movaps	%xmm0, 16(%rsp)
                	movq	$0, 8(%rsp)
-               	leaq	228759(%rip), %rax      # 0x458190 <ktypeglobal:ForLoopsBenchmark#internal>
+               	leaq	234199(%rip), %rax      # 0x4598d0 <ktypeglobal:ForLoopsBenchmark#internal>
                	orq	$3, %rax
                	movq	%rax, (%rsp)
                	movq	%fs:0, %rax
@@ -20,10 +20,10 @@
                	...
                	movq	%rbx, 32(%rsp)
-               	movb	260367(%rip), %al       # 0x45fd50 <kotlin::mm::internal::gSuspensionRequested>
+               	movb	265815(%rip), %al       # 0x461498 <kotlin::mm::internal::gSuspensionRequested>
                	testb	$1, %al
-               	je	0x42044a <kfun:#main(){}+0x7a>
-               	callq	0x423f10 <kotlin::mm::SuspendIfRequestedSlowPath()>
+               	je	0x42064a <kfun:#main(){}+0x7a>
...
+               	callq	0x427c70 <kotlin::mm::internal::ObjectFactoryStorage<8ul, kotlin::gc::AllocatorWithGC<kotlin::gc::Allocator, kotlin::gc::ConcurrentMarkAndSweep::ThreadData> >::Producer::Insert(unsigned long)>
                	...
                	movups	%xmm0, 8(%rax)
                	movq	$0, 24(%rax)
-               	leaq	216706(%rip), %rax      # 0x455330 <ktypeglobal:kotlin.IntArray#internal>
+               	leaq	222146(%rip), %rax      # 0x456a70 <ktypeglobal:kotlin.IntArray#internal>
                	movq	%rax, 16(%r12)
...
+               	callq	0x424540 <kotlin::mm::SuspendIfRequestedSlowPath()>
                	movl	24(%r12), %eax
                	cmpq	%rax, %rbx
-               	jae	0x420562 <kfun:#main(){}+0x192>
+               	jae	0x420762 <kfun:#main(){}+0x192>
                	movq	16(%r12), %rax
...
+               	jne	0x4206d0 <kfun:#main(){}+0x100>
                	...
                	movl	8(%rax), %ebx
                	addl	$-1, %ebx
-               	js	0x420549 <kfun:#main(){}+0x179>
+               	js	0x420749 <kfun:#main(){}+0x179>
                	xorl	%ebp, %ebp
-               	jmp	0x420537 <kfun:#main(){}+0x167>
+               	jmp	0x420737 <kfun:#main(){}+0x167>
                	nopw	(%rax,%rax)
                	addl	$1, %ebp
                	cmpl	%ebx, %ebp
-               	jg	0x420549 <kfun:#main(){}+0x179>
-               	movzbl	260114(%rip), %eax      # 0x45fd50 <kotlin::mm::internal::gSuspensionRequested>
+               	jg	0x420749 <kfun:#main(){}+0x179>
