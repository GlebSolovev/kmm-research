--- ../../benchmarkAnalysis/Ring::Fibonacci.calc/linuxX64/baseline/bincode/mainfun_bincode.asm	2023-07-19 02:53:14.680539526 +0200
+++ ../../benchmarkAnalysis/Ring::Fibonacci.calc/linuxX64/unordered/bincode/mainfun_bincode.asm	2023-07-19 03:04:42.790330850 +0200
@@ -5,7 +5,7 @@
                	xorps	%xmm0, %xmm0
                	movaps	%xmm0, 32(%rsp)
                	movaps	%xmm0, 16(%rsp)
...
-               	jmp	0x420454 <kfun:#main(){}+0x84>
+               	jmp	0x420654 <kfun:#main(){}+0x84>
                	incl	%ebp
-               	je	0x420466 <kfun:#main(){}+0x96>
-               	movzbl	260341(%rip), %eax      # 0x45fd50 <kotlin::mm::internal::gSuspensionRequested>
