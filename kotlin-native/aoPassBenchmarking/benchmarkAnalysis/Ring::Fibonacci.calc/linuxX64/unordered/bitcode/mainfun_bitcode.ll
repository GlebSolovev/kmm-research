...
do_while_loop.i:                                  ; preds = %Kotlin_mm_safePointWhileLoopBody.exit.i, %Kotlin_mm_safePointFunctionPrologue.exit
  %inductionVariable.0.i = phi i32 [ 10000, %Kotlin_mm_safePointFunctionPrologue.exit ], [ %23, %Kotlin_mm_safePointWhileLoopBody.exit.i ]
...
Kotlin_mm_safePointWhileLoopBody.exit.i:          ; preds = %22, %do_while_loop.i
  %23 = add nsw i32 %inductionVariable.0.i, -1
  %.not = icmp eq i32 %23, 0
  br i1 %.not, label %epilogue, label %do_while_loop.i
