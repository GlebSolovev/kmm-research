--- ../../benchmarkAnalysis/Ring::Fibonacci.calcClassic/linuxX64/baseline/bincode/mainfun_bincode.asm	2023-07-19 02:47:19.640652351 +0200
+++ ../../benchmarkAnalysis/Ring::Fibonacci.calcClassic/linuxX64/unordered/bincode/mainfun_bincode.asm	2023-07-19 02:59:16.270428241 +0200
@@ -5,7 +5,7 @@
                	xorps	%xmm0, %xmm0
                	movaps	%xmm0, 32(%rsp)
                	movaps	%xmm0, 16(%rsp)
