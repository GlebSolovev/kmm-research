--- ../../benchmarkAnalysis/Ring::MultithreadedLoops.sumStringByIndices5Workers/linuxX64/baseline/bitcode/mainfun_bitcode.ll	2023-07-19 02:52:58.430543413 +0200
+++ ../../benchmarkAnalysis/Ring::MultithreadedLoops.sumStringByIndices5Workers/linuxX64/unordered/bitcode/mainfun_bitcode.ll	2023-07-19 03:04:27.860335541 +0200
@@ -10,11 +10,11 @@
...
-  store %struct.TypeInfo* getelementptr inbounds ({ %struct.TypeInfo, [3 x i8*] }, { %struct.TypeInfo, [3 x i8*] }* @"ktypeglobal:MultithreadedLoopsBenchmark.$runSumStringByIndicesWorkers$lambda$0$FUNCTION_REFERENCE$0#internal", i64 0, i32 0), %struct.TypeInfo** %363, align 8, !tbaa !14
...
-  store %struct.ObjHeader* (%struct.ObjHeader*, %struct.ObjHeader**)* @"kfun:MultithreadedLoopsBenchmark.$<bridge-BNNN>runSumStringByIndicesWorkers$lambda$1#static(kotlin.String){}kotlin.Long#internal", %struct.ObjHeader* (%struct.ObjHeader*, %struct.ObjHeader**)** %324, align 8, !tbaa.struct !112
