...
Kotlin_mm_safePointFunctionPrologue.exit:         ; preds = %22, %entry
  %23 = load atomic i32, i32* @"state_global$<root>$/home/loewe/tabs/kmm-research/kotlin-native/aoPassBenchmarking/benchmarkAnalysis/Ring::Switch.testSparseIntSwitch/Main.kt" acquire, align 4
  %24 = icmp eq i32 %23, 2
  br i1 %24, label %call_success1, label %call_success

call_success:                                     ; preds = %Kotlin_mm_safePointFunctionPrologue.exit
  call fastcc void @CallInitGlobalPossiblyLock(i32* nonnull @"state_global$<root>$/home/loewe/tabs/kmm-research/kotlin-native/aoPassBenchmarking/benchmarkAnalysis/Ring::Switch.testSparseIntSwitch/Main.kt", void ()* nonnull @"kfun:$init_global#internal")
...
call_success1:                                    ; preds = %call_success, %Kotlin_mm_safePointFunctionPrologue.exit
  ...
  br i1 %.not.i.i, label %when_next.i.i, label %"kfun:SwitchBenchmark#<get-sparseIntData>(){}kotlin.IntArray.exit.i"
...
"kfun:SwitchBenchmark#<get-sparseIntData>(){}kotlin.IntArray.exit.i": ; preds = %call_success1
...
"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i": ; preds = %label_init.i.i, %Kotlin_mm_safePointWhileLoopBody.exit.i
  ...
  switch i32 %68, label %when_next40.i.i [
    i32 11, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 29, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split"
    i32 47, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split3"
    i32 71, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split4"
    i32 103, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split5"
    i32 149, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split6"
    i32 175, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split7"
    i32 227, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 263, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split8"
    i32 307, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 361, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split9"
    i32 487, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split10"
    i32 563, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split11"
    i32 617, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split12"
    i32 677, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split13"
    i32 751, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split14"
    i32 823, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split15"
    i32 883, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 967, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 1031, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"
    i32 20, label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"
  ]

when_next40.i.i:                                  ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split3": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split4": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split5": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split6": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split7": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split8": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split9": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split10": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split11": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split12": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split13": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split14": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split15": ; preds = %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  br label %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i"

"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i": ; preds = %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split15", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split14", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split13", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split12", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split11", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split10", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split9", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split8", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split7", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split6", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split5", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split4", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split3", %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split", %when_next40.i.i, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i", %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i"
  %t.0.i.i = phi i32 [ 5, %when_next40.i.i ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 2, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split" ], [ 3, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split3" ], [ 4, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split4" ], [ 5, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split5" ], [ 6, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split6" ], [ 7, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split7" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 9, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split8" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 2, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split9" ], [ 3, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split10" ], [ 4, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split11" ], [ 4, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split12" ], [ 4, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split13" ], [ 435, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split14" ], [ 31, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i.fold.split15" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ], [ 1, %"kfun:Blackhole#<get-$companion>#static(){}Blackhole.Companion.exit.i" ]
...
loop_check.i:                                     ; preds = %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i", %"kfun:SwitchBenchmark#<get-sparseIntData>(){}kotlin.IntArray.exit.i"
  %indvars.iv = phi i64 [ %indvars.iv.next, %"kfun:SwitchBenchmark#sparseIntSwitch(kotlin.Int){}kotlin.Int.exit.i" ], [ 0, %"kfun:SwitchBenchmark#<get-sparseIntData>(){}kotlin.IntArray.exit.i" ]
