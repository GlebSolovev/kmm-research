--- ../../benchmarkAnalysis/Ring::MultithreadedLoops.sumIntArray100Workers/linuxX64/baseline/bincode/bincode.asm	2023-07-19 02:52:50.710545911 +0200
+++ ../../benchmarkAnalysis/Ring::MultithreadedLoops.sumIntArray100Workers/linuxX64/unordered/bincode/bincode.asm	2023-07-19 03:04:20.480337741 +0200

@@ -1,5 +1,5 @@
@@@[(1, 3)]@@@
-../../benchmarkAnalysis/Ring::MultithreadedLoops.sumIntArray100Workers/linuxX64/baseline/main.kexe:	file format elf64-x86-64
+../../benchmarkAnalysis/Ring::MultithreadedLoops.sumIntArray100Workers/linuxX64/unordered/main.kexe:	file format elf64-x86-64
...
-               	callq	0x426370 <kotlin::mm::SuspendIfRequestedSlowPath()>
-               	testq	%rbx, %rbx
-               	leaq	268647(%rip), %r12      # 0x461440 <__unnamed_8>
-               	cmovneq	%rbx, %r12
...
@@@@
-               	movq	%rbx, 56(%rsp)
-               	leaq	264304(%rip), %rsi      # 0x461e80 <__unnamed_61>
...
@@ -13745,23 +13875,24 @@
@@@[(6, 23), (28, 32)]@@@
-               	je	0x4217a9 <kfun:MultithreadedLoopsBenchmark.$runSumIntArrayWorkers$lambda$0$FUNCTION_REFERENCE$0.invoke#internal+0x19>
-               	callq	0x426370 <kotlin::mm::SuspendIfRequestedSlowPath()>
-               	movq	8(%rbx), %rcx
-               	movslq	16(%rbx), %rax
-               	movq	8(%rcx), %rcx
-               	cmpl	%eax, 8(%rcx)
-               	jbe	0x4217ca <kfun:MultithreadedLoopsBenchmark.$runSumIntArrayWorkers$lambda$0$FUNCTION_REFERENCE$0.invoke#internal+0x3a>
...
-               	leaq	121817(%rip), %rsi      # 0x45b4e0 <ktypeglobal:kotlin.String#internal>
-               	movq	%rbx, %rdi
