...
import org.jetbrains.kotlin.dependencies.NativeDependenciesConsumerExtension
...
open class GitClangFormatPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        target.apply<NativeDependenciesConsumerPlugin>()
        val nativeDependencies = target.extensions.getByType<NativeDependenciesConsumerExtension>()
        nativeDependencies.llvm()
