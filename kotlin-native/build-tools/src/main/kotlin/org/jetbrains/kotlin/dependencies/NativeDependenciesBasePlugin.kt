 ...
 * For consuming native dependencies see [NativeDependenciesConsumerPlugin]
 *
 * @see NativeDependenciesDownloaderPlugin
 * @see NativeDependenciesConsumerPlugin
 */
...
class NativeDependenciesBasePlugin : Plugin<Project> {
    ...
    companion object {
        internal fun dependencyCapability(project: Project, dependency: String) = "${project.group}:${project.name}-$dependency:${project.version}"
    }
}